    ...
    <section className="w-full py-24 px-12 bg-slate-950 neural-grid">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-5xl md:text-6xl font-black text-white mb-6">
          Team <span className="saktrix-aurora-text">Protocols</span>
        </h2>
        <p className="text-slate-400 text-lg max-w-2xl mb-16">
          Premium team and member showcase layouts designed to emphasize the talent behind the neural network.
        </p>
      </div>
