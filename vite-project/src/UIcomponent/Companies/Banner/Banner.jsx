    ...
    <section className="w-full py-24 px-12 bg-slate-950 neural-grid">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-5xl md:text-6xl font-black text-white mb-6">
          Banner <span className="saktrix-aurora-text">Protocols</span>
        </h2>
        <p className="text-slate-400 text-lg max-w-2xl mb-16">
          High-impact announcement and notification banner components engineered with futuristic neural aesthetics for mission-critical broadcasts.
        </p>
      </div>
